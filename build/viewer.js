...
(function (root, factory) {
  {
	...
	exports.AnnoInfo = (function AnnoInfoClosure() {
		...
		function AnnoInfo(options) {
			...
			this.annoRegistry.onGetAnnotations(function annoInfoCheckAnnotationFeatures(e, x) {
				this.checkAnnotationFeatures(e, x)
			}.bind(this), function annoInfoCheckAnnotationFeatures(e, x) {
				this.checkAnnotationFeatures(e, x)
			}.bind(this));
		}
		...
		AnnoInfo.prototype = {
			...
			load: function () {
				...
				this.annoRegistry.onGetAnnotations(function showInfoAnnotations(data) {
					return this.showInfoAnnotations(data)
				}.bind(this));
...
var PDFViewerApplication = {
  ...
  bindEvents: function pdfViewBindEvents() {
	...
	/**
     * checks if file and viewer have the same origin and if this is allowed in config
	 * @param file
	 */
